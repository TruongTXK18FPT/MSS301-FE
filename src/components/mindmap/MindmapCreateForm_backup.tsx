        ...
        <div className="relative">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-white/90 text-sm mt-1">Chọn loại mindmap và bắt đầu học tập thông minh</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <Card className="border-0 shadow-2xl rounded-2xl overflow-hidden bg-white">
        <CardContent className="p-6">
              ...
              <button
                ...
                className={`p-6 rounded-xl border-2 transition-all text-left ${
                  mindmapType === 'general'
                    ...
                    : 'border-gray-600 bg-gradient-to-br from-slate-800/50 to-slate-900/50 hover:border-purple-500/60 hover:shadow-lg hover:shadow-purple-500/10'
                }`}
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h4 className="font-bold text-lg mb-2 flex items-center gap-2 text-white">
                      Kiến thức Tổng quát
                      {mindmapType === 'general' && (
                        <Badge className="bg-purple-600 text-white">Đang chọn</Badge>
                      )}
                    </h4>
              ...
              <button
                ...
                className={`p-6 rounded-xl border-2 transition-all text-left ${
                  mindmapType === 'document'
                    ...
                    : 'border-gray-600 bg-gradient-to-br from-slate-800/50 to-slate-900/50 hover:border-blue-500/60 hover:shadow-lg hover:shadow-blue-500/10'
                }`}
              >
                <div className="flex items-start gap-4">
                  <div className={`p-3 rounded-lg transition-all ${
                  ...
                  <div className="flex-1">
                    <h4 className="font-bold text-lg mb-2 flex items-center gap-2 text-white">
                      Theo Giáo trình
                      {mindmapType === 'document' && (
                        <Badge className="bg-blue-600 text-white">Đang chọn</Badge>
                      )}
                    </h4>
                    <p className="text-sm text-gray-300 mb-3 leading-relaxed">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Basic Tab */}
            {activeTab === 'basic' && (
              <div className="space-y-6 animate-in fade-in-50 slide-in-from-left-3 duration-300">
                <div className="grid gap-6">
                  <div className="relative group">
                    <Label htmlFor="title" className="text-base font-bold mb-3 block text-gray-900">
                      <BookOpen className="inline-block mr-2 h-5 w-5 text-blue-600" />
                    ...
                    <Input
                      ...
                      className="peer transition-all focus:ring-2 focus:ring-blue-500 h-11 text-base bg-white"
                    />
                  ...
                  <div className="relative group">
                    <Label htmlFor="description" className="text-base font-bold mb-3 block text-gray-900">
                      <Info className="inline-block mr-2 h-5 w-5 text-purple-600" />
                    ...
                    <Textarea
                      ...
                      rows={3}
                      className="transition-all focus:ring-2 focus:ring-purple-500 text-base bg-white"
                    />
                    <p className="mt-1 text-xs text-gray-500">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-3">
                      <Label htmlFor="grade" className="text-base font-bold text-gray-900">
                        <GraduationCap className="inline-block mr-2 h-5 w-5 text-green-600" />
                        Lớp học <span className="text-red-500">*</span>
                      </Label>
                      <Select value={formData.grade} onValueChange={(value) => handleInputChange('grade', value)}>
                        <SelectTrigger className="transition-all bg-white">
                    ...
                    <div className="space-y-3">
                      <Label htmlFor="cognitiveLevel" className="text-base font-bold text-gray-900">
                        <Target className="inline-block mr-2 h-5 w-5 text-orange-600" />
                        Mức độ tư duy
                      </Label>
                  ...
                  <div className="space-y-3">
                    <Label className="text-base font-bold text-gray-900">
                      <Zap className="inline-block mr-2 h-5 w-5 text-pink-600" />
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      {DIFFICULTY_LEVELS.map((level) => (
                          ...
                          className={`p-4 rounded-lg border-2 transition-all duration-200 text-left cursor-pointer ${
                            formData.difficulty === level.value
                              ? level.value === 'easy'
                                ...
                                : level.value === 'hard'
                                ? 'border-red-500 bg-red-50 ring-2 ring-red-200 shadow-lg'
                        ...
                        >
                          <div className={`w-full h-2 rounded-full mb-3 ${level.color}`}></div>
                          <div className="font-bold text-base text-gray-900">{level.label}</div>
                          <div className="text-xs text-gray-700 mt-2 leading-relaxed font-medium">{level.description}</div>
                        </button>
                      ))}
                    </div>
                  </div>
            ...
            <div className="flex gap-4 pt-6 border-t-2 border-gray-200 mt-8">
              <Button
                ...
                className="flex-1 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white shadow-lg hover:shadow-xl transition-all h-12 text-base font-bold"
                size="lg"
              >
                {isGenerating ? (
                  <>
              ...
              <Button
                ...
                disabled={isGenerating}
                className="flex-1 border-gray-300 text-gray-700 hover:bg-gray-100 hover:border-gray-400 hover:text-gray-900 transition-all h-12 text-base font-bold"
                size="lg"
              >
                {isGenerating ? (
                  <>
              ...
              {onCancel && (
                <Button
                  ...
                  onClick={onCancel}
                  disabled={isGenerating}
                  className="text-gray-700 hover:bg-gray-100 hover:text-gray-900 transition-all h-12 text-base font-bold"
                  size="lg"
                >
                  Hủy
                </Button>
